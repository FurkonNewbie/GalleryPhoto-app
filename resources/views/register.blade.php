        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form action="{{ route('cek_register') }}" method="post" class="max-w-md mx-auto w-full"
                        ...
                        {{-- <div class="relative z-0 w-full mb-5 group">
                                <input type="number" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" name="no_telepon"
                                    id="floating_phone"
                                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    placeholder=" " required />
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Sudah punya akun?
                            <a href="{{ route('login') }}"
                                class="font-medium text-[#387780]-600 hover:underline dark:text-[#387780]-500">Login
                                disini</a>
                        </p>
                    </form>
                </div>
